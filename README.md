...
POST - create new entries into database. GET - retrieve info from database. PUT - updates existing entries with new data delete, deletes an entry in the database.
